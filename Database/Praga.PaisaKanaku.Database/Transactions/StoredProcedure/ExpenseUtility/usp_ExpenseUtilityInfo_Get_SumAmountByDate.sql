CREATE PROCEDURE [Transactions].[usp_ExpenseUtilityInfo_Get_SumAmountByDate]
	@Month INT,
	@Year INT,
...
BEGIN TRY
	...
	INSERT INTO @ExpenseUtilityInfo([ExpenseDate], [TotalExpenseAmount])
	SELECT [ExpenseDate], SUM([ExpenseAmount])
	FROM [Transactions].[ExpenseUtilityBaseInfo] 
